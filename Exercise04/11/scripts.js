...
progress.addEventListener("mousemove", (e) => skipping && scrub(e));
progress.addEventListener("mousedown", () => skipping = true);
progress.addEventListener("mouseup", () => skipping = false);
